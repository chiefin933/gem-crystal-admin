              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Two piece (skirt/trouser)">Two piece (skirt/trouser)</option>
                    <option value="Three piece">Three piece</option>
                    <option value="Straight jeans">Straight jeans</option>
                    <option value="Mommy jeans">Mommy jeans</option>
                    <option value="Hoodies">Hoodies</option>
                    <option value="Leather jackets">Leather jackets</option>
                    <option value="Crop jackets">Crop jackets</option>
                    <option value="Trench coats">Trench coats</option>
                    <option value="Heels">Heels</option>
                    <option value="Sneakers">Sneakers</option>
                    <option value="Torte Bags">Torte Bags</option>
                  </select>
                </div>
